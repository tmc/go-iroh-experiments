...
const file_greeter_proto_rawDesc = "" +
	...
	"\rLotsOfReplies\x12\x15.greeter.HelloRequest\x1a\x13.greeter.HelloReply0\x01\x12?\n" +
	"\x0fLotsOfGreetings\x12\x15.greeter.HelloRequest\x1a\x13.greeter.HelloReply(\x01\x12;\n" +
	"\tBidiHello\x12\x15.greeter.HelloRequest\x1a\x13.greeter.HelloReply(\x010\x01B@Z>github.com/tmc/go-iroh-experiments/grpciroh/internal/greeterpbb\x06proto3"
...
var file_greeter_proto_depIdxs = []int32{
	...
	0, // 1: greeter.Greeter.LotsOfReplies:input_type -> greeter.HelloRequest
	0, // 2: greeter.Greeter.LotsOfGreetings:input_type -> greeter.HelloRequest
	0, // 3: greeter.Greeter.BidiHello:input_type -> greeter.HelloRequest
	1, // 4: greeter.Greeter.SayHello:output_type -> greeter.HelloReply
	1, // 5: greeter.Greeter.LotsOfReplies:output_type -> greeter.HelloReply
	1, // 6: greeter.Greeter.LotsOfGreetings:output_type -> greeter.HelloReply
	1, // 7: greeter.Greeter.BidiHello:output_type -> greeter.HelloReply
